"""
Django settings for bitacoras_api project.
...
SECRET_KEY = 'django-insecure-fxj2+@lg76j#qy#aegd@i1_er^c_(pp^2muewa3umhp(9vkbbi'
...
ROOT_URLCONF = 'bitacoras_api.urls'
...
WSGI_APPLICATION = 'bitacoras_api.wsgi.application'
