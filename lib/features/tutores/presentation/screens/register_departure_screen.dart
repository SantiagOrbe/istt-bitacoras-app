...
class RegisterDepartureScreen extends StatefulWidget {
  final UserModel currentUser;

  const RegisterDepartureScreen({super.key, required this.currentUser});

  @override
  State<RegisterDepartureScreen> createState() => _RegisterDepartureScreenState();
}

class _RegisterDepartureScreenState extends State<RegisterDepartureScreen> {
  final FakeTutorRepository _repo = FakeTutorRepository();
  AssignedStudentModel? _selectedStudent;
