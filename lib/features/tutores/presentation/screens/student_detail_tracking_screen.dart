...
class StudentDetailTrackingScreen extends StatefulWidget {
  final AssignedStudentModel assignedStudent;

  const StudentDetailTrackingScreen({super.key, required this.assignedStudent});

  @override
  State<StudentDetailTrackingScreen> createState() => _StudentDetailTrackingScreenState();
}

class _StudentDetailTrackingScreenState extends State<StudentDetailTrackingScreen> {
