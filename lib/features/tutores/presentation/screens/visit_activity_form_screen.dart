...
class VisitActivityFormScreen extends StatefulWidget {
  final AcademicVisitModel visit;

  const VisitActivityFormScreen({super.key, required this.visit});

  @override
  State<VisitActivityFormScreen> createState() => _VisitActivityFormScreenState();
}

class _VisitActivityFormScreenState extends State<VisitActivityFormScreen> {
