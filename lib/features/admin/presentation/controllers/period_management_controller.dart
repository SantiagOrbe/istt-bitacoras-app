...
class PeriodManagementController extends ChangeNotifier {
  final IAdminRepository repository;

  PeriodManagementController({required this.repository});
  ...
  List<PeriodModel> get filteredPeriods {
  ...
  Future<bool> deactivatePeriod(PeriodModel period) async {
    if (!period.isActive) {
      return true;
    }
  ...
  Future<bool> activatePeriod(PeriodModel period) async {
    return savePeriod(
      periodId: period.id,
      name: period.name,
      startDate: period.startDate,
  ...
  Future<void> _syncActiveState(PeriodModel targetPeriod) async {
