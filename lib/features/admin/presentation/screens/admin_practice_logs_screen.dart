...
import '../../domain/models/practice_log_model.dart';

class AdminPracticeLogsScreen extends StatefulWidget {
  final UserModel currentUser;

  const AdminPracticeLogsScreen({
    super.key,
    required this.currentUser,
  });

  @override
  State<AdminPracticeLogsScreen> createState() => _AdminPracticeLogsScreenState();
}

class _AdminPracticeLogsScreenState extends State<AdminPracticeLogsScreen> {
  ...
  Widget _buildLogCard(PracticeLogModel log) {
    Color statusColor;
