...
class InicioTutorAcademicoScreen extends StatelessWidget {
  const InicioTutorAcademicoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return LocationCheckerWrapper(
      child: InicioScreen(
        user: FakeUsuarioRepository.academicTutor,
        actions: FakeTableroRepository().academicTutorActions(),
      ),
    );
  }
}